...
const getNsfwImage = async (m, sock) => {
  ...
  const botNumber = config.SUDO_NUMBER;  // The bot's phone number (without the + sign, e.g. "22781289418")
  const ownerNumber = config.OWNER_NUMBER;  // The bot owner's phone number (without the + sign, e.g. "22781289418")
